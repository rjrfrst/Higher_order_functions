...
describe('ScranAdvisor', () => {
    ...
    test('can count the number of restaurants', () => {
        const expected = 23;
        const actual = scranAdvisor.countAllRestaurants();
    ...
    test('can find Happy Lamb Hot Pot restaurant by full name', () => {
        ...
        const actual = scranAdvisor.findRestaurantName("Happy Lamb Hot Pot");
        expect(actual).toEqual(expected);
    })
    ...
    test('can find the name of all restaurants', () => {
        const expected = [
          ...
          const actual = scranAdvisor.findAllRestaurantsByName();
          expect(actual).toEqual(expected);
    })
    ...
    test('can find all restaurants from Glasgow', () => {
        const expected = [
          ...
          const actual = scranAdvisor.restaurantsByLocation("Glasgow");
          expect(actual).toEqual(expected);
    })
